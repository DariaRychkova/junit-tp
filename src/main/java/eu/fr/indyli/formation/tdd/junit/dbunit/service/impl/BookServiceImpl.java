...
public class BookServiceImpl extends java.util.Observable implements IBookService {
	...
	@Override
	public synchronized void addObserver(@SuppressWarnings("deprecation") Observer o) {
	...
	@Override
	public synchronized void deleteObserver(@SuppressWarnings("deprecation") Observer o)
