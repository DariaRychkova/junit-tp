...
public interface IBookService {
	...
	public void addObserver(@SuppressWarnings("deprecation") Observer o);
	...
	/**
	 * Retourne le nombre de bouquins disponibles dont la date de parution est
	 * superieure a une certaine date donnee
	 * 
	 * @param date
	 * @return
	 */
